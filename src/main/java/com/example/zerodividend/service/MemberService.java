...
import com.example.zerodividend.exception.impl.AlreadyExistUserException;
import com.example.zerodividend.model.Member;
import com.example.zerodividend.persist.MemberRepository;
...
public class MemberService implements UserDetailsService {
    ...
    public Member register(Member.SignUp member) {
    ...
    public Member authenticate(Member.SignIn member) {
